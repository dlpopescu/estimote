...
namespace Estimotes.Droid
{
    ...
    public class NotificationActivity : Activity, BeaconManager.IServiceReadyCallback
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            // Default values are 5sec of scanning and 25sec of waiting time (something about CPU cycles).
